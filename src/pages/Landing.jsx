...
const PARTNERS_DATA = [
  ...
  },
  {
    ...
    partners: [{ name: "Community X" }, { name: "Community X" }, { name: "Community X" }],
  },
];
          ...
          >
            <img
              ...
              className={`h-full w-full object-cover transition-all duration-700 ease-out ${
                isActive ? "grayscale-0 brightness-105 scale-[1.03]" : "grayscale brightness-[0.7]"
              }`}
            />
            <div
              className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent transition-opacity duration-500 pointer-events-none ${isActive ? "opacity-45" : "opacity-90"}`}
            />
            <div
              className={`absolute inset-0 rounded-2xl pointer-events-none border transition-all duration-300 ${
                isActive
      ...
      <main>
        ...
        <LazySection>
          <SectionShell
            id="partners"
            title="Partners"
            eyebrow="Allied Forces"
            subtitle="Our trusted allies in this heist."
            centeredHeading
            isMobile={isMobile}
          >
            <ScrollTitleMarquee
              rows={PARTNERS_DATA}
              partnerCta="https://fortune-cowl-835.notion.site/Hack-Heist-2-0-2bf0d83def6381f0af4bd849f5068fea"
            />
          </SectionShell>
        </LazySection>
