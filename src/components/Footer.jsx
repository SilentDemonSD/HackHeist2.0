  ...
  return (
    <footer className="relative border-t border-white/[0.06] bg-[#060606]">
      ...
      >
          ...
          <motion.div variants={rise} className="space-y-5">
            ...
            <div className="space-y-4">
              <motion.a
                ...
                whileHover={{ x: 3 }}
              >
                <span className="text-red-500/50 mt-0.5 text-xs font-mono select-none" aria-hidden>
                  &gt;
                </span>
                <span>
                  <span
        ...
        <motion.div variants={rise} className="mt-6 flex flex-col items-center gap-3">
          <p
