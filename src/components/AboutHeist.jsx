...
const highlights = [
  {
    ...
    desc: "36 hours of non-stop building, learning, and competing.",
  },
  {
    icon: "🧠",
    title: "Expert Mentors",
    desc: "Continuous guidance from industry professionals throughout.",
  },
  {
    icon: "🌐",
    title: "Open to All",
    desc: "Beginners to veterans — everyone has a place at the heist.",
  },
];
...
const iconPaths = {
  ...
  location: (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 21.5C12 21.5 5 13.985 5 9.5C5 5.91 7.91 3 11.5 3C15.09 3 18 5.91 18 9.5C18 13.985 11 21.5 11 21.5H12Z"
        stroke="#FF4D4F"
        strokeWidth="1.5"
      />
          ...
          <div className={styles.leftCol}>
            <motion.div className={styles.copyBlock} variants={fadeUp} custom={1}>
              ...
              <p>
                ...
                developers, designers, and innovators to build impactful solutions for real-world
                problems. From ideation and team formation to building and showcasing working
                prototypes — it&apos;s a complete end-to-end experience.
              </p>
              <p>
                Collaborate with peers, work on industry-relevant problem statements, get continuous
                mentorship, and push your limits with nonstop coding and exciting challenges.
              </p>
              <p>
                Whether you&apos;re a beginner eager to learn or an experienced hacker ready to
                compete, Hack Heist 2.0 is the arena where bold ideas become real impact.
              </p>
            </motion.div>
              ...
              <>
                ...
                >
                  ...
                  <rect
                    ...
                    width="424"
                    height="22"
                    fill="rgba(167,209,255,0.04)"
                    stroke="rgba(167,209,255,0.25)"
                    strokeWidth="0.8"
                  />
                  <text
                    x="30"
                  ...
                  />
                  <path
                    d="M225,162 L218,172 L232,172 Z"
                    fill="none"
                  ...
                  <line
                    ...
                    x2="90"
                    y2="192"
                    stroke="rgba(167,209,255,0.35)"
                    strokeWidth="0.7"
                  />
                  <path
                    d="M63,175 Q81,165 99,175"
                    fill="none"
                  ...
                  />
                  <path
                    d="M58,170 Q81,157 104,170"
                    fill="none"
                    stroke="rgba(167,209,255,0.2)"
                    strokeWidth="0.7"
                    strokeDasharray="2 3"
                  />
                  <text
                  ...
                  />
                  <path
                    d="M150,249 L143,255 L157,255 Z"
                    fill="none"
                  ...
                  />
                  <path
                    d="M320,249 L313,255 L327,255 Z"
                    fill="none"
                    stroke="rgba(255,200,0,0.3)"
                    strokeWidth="0.7"
                  />
                  ...
                  <text
                    ...
                    y="495"
                    textAnchor="middle"
                    fill="rgba(255,77,79,0.28)"
                    fontSize="5"
                    fontFamily="monospace"
                    letterSpacing="1.5"
                  >
                    HACKHEIST 2.0 · GDG ON CAMPUS MIET · CLASSIFIED
                  </text>
                </svg>
